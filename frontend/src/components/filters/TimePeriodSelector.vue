    ...
    <div class="flex flex-col sm:flex-row sm:items-center gap-3">
      ...
      >
        <button
          ...
          class="relative px-4 py-2 text-sm font-medium transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-800"
          :class="[
        ...
        >
          ...
          <span
            ...
            class="absolute inset-0 bg-gradient-to-r from-emerald-600 to-emerald-500 dark:from-emerald-500 dark:to-emerald-400 rounded-md shadow-sm"
          />
          <!-- Label -->
